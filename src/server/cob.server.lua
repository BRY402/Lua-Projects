...
local Description = lib.Create("HumanoidDescription", nil, {
	HeadColor = Color3.new(.8, .5, .4),
	TorsoColor = Color3.new(1, 0, 0),
	RightArmColor = Color3.new(.8, .5, .4),
	LeftArmColor = Color3.new(.8, .5, .4),
	RightLegColor = Color3.new(.5, .5, .5),
	LeftLegColor = Color3.new(.5, .5, .5),
    HairAccessory = "62234425"
})
local target = nil
local replies = {
    "At your wish!",
